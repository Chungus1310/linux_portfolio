...
app.use('/data', express_1.default.static(path_1.default.join(__dirname, '../public/data')));
// API Routes
...
app.get('/api/portfolio-config', (req, res) => {
    try {
        ...
        const configPath = path_1.default.join(__dirname, '../public/data/portfolio-config.json');
...
app.get('/api/projects', (req, res) => {
    try {
        const projectsPath = path_1.default.join(__dirname, '../public/data/projects.json');
...
app.get('/api/files/*', (req, res) => {
    ...
    try {
        ...
        const staticPath = path_1.default.join(__dirname, '../public/data', filePath);
...
app.get('*', (req, res) => {
    const indexPath = path_1.default.join(__dirname, '../dist/client/index.html');
